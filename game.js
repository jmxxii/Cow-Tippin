...
var mikeLeftIdle = new Image();
mikeLeftIdle.src = "../Cow-Tipping/images/mike-left-idle@216x-8.png";
var mikeLeft1 = new Image();
mikeLeft1.src = "../Cow-Tipping/images/Mike-left-1@216x-8.png";
var mikeLeft2 = new Image();
mikeLeft2.src = "../Cow-Tipping/images/mike-left-2@216x-8.png";
var mikeStraight = new Image();
mikeStraight.src = "../Cow-Tipping/images/mike-idle@216x-8.png"

var musicTheme = new Audio("../Cow-Tipping/Sound/Toon-sound.wav");
var jumpSound = new Audio("../Cow-Tipping/Sound/Cartoon_Jump.wav");
...
var treeHouse = {
  ...
  height: 85,
  draw: function(){
    context.drawImage(door, treeHouse.x, treeHouse.y, treeHouse.width, treeHouse.height);
  }
};
...
console.log("mikeRight array: ", mikeRight)
console.log(mikeRight)

var mikeLeft = [];
mikeLeft.push(mikeLeftIdle);
mikeLeft.push(mikeLeft1);
mikeLeft.push(mikeLeftIdle);
mikeLeft.push(mikeLeft2);
...
function levelCompleted(){
  clearCanvas();
  complete = true;
  context.drawImage(levelEnd, 0, 0, 720, 1200)
}
function reset(){
